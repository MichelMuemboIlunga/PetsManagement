  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="cartCats.php"><i class="fas fa-shopping-cart"></i> <span id="cart-item" class="badge badge-danger"></span></a>
        </li>
      </ul>
    </div>
  </nav>
  ...
  <div class="container">
    ...
    <div class="row mt-2 pb-3">
      <?php
  			...
  			$stmt = $conn->prepare('SELECT * FROM tcatsproduct');
  			$stmt->execute();
